<template>
  ...
  <div class="location-contain">
    <div class="locations">
      <LocationItem v-for="(location, i) in locations" :key="i" :location="location">
        <!-- Inject outer HTML from parent to child. About slots, here: https://vuejs.org/guide/components/slots.html#named-slots -->
        <template v-slot:header>
          <h1>Location header</h1>
        </template>
      </LocationItem>
    </div>
  </div>
